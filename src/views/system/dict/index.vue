    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryFormRef" :inline="true" v-show="showSearch" label-width="70px">
            <el-form-item label="字典名称" prop="dictName">
                <el-input maxlength="100" v-model="queryParams.dictName" placeholder="请输入字典名称" clearable style="width: 240px" />
            </el-form-item>
            <el-form-item label="字典类型" prop="dictType">
                <el-input maxlength="100" v-model="queryParams.dictType" placeholder="请输入字典类型" clearable style="width: 240px" />
            </el-form-item>
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button type="danger" plain icon="refresh" size="small" @click="handleClearCache" v-hasPermi="['system:dict:remove']">清理缓存</el-button>
            </el-col>
        ...
        <el-table stripe border height="560px" v-loading="loading" ref="pageTableRef" :data="typeList">
            ...
            <el-table-column label="字典类型" align="center" min-width="120" :show-overflow-tooltip="true">
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body @closed="cleanSelect()">
            <el-form ref="formRef" :model="form" :rules="rules" label-width="80px">
                <el-form-item label="字典名称" prop="dictName">
                    <el-input maxlength="100" v-model="form.dictName" placeholder="请输入字典名称" />
                </el-form-item>
                <el-form-item label="字典类型" prop="dictType">
                    <el-input maxlength="100" v-model="form.dictType" placeholder="请输入字典类型" />
                </el-form-item>
