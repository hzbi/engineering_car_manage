        ...
        <el-row :gutter="24">
            ...
            <el-col :span="24" :xs="24">
                <transition name="fade">
                    <el-form :model="queryParams" ref="queryFormRef" :inline="true" v-show="showSearch">
                        ...
                        <el-form-item label="手机号码" prop="phonenumber">
                            <el-input v-model="queryParams.phonenumber" placeholder="请输入手机号码" clearable style="width: 150px" @keyup.enter.native="handleQuery" />
                        </el-form-item>
                        ...
                        <el-form-item label="状态" prop="status">
                            <el-select v-model="queryParams.status" placeholder="请选择状态" style="width: 120px" clearable @change="handleQuery">
                                <el-option v-for="dict in sys_normal_disable" :key="dict.value" :label="dict.label" :value="dict.value" />
                            </el-select>
                        </el-form-item>
                        <el-form-item label="创建时间" style="font-weight: bold">
                            <el-date-picker v-model="dateRange" style="width: 240px" format="YYYY-MM-DD" value-format="YYYY-MM-DD" type="daterange" range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期"></el-date-picker>
                        </el-form-item>
                ...
                <el-table stripe border v-loading="loading" ref="pageTableRef" :data="userList" @selection-change="handleSelectionChange">
                    ...
                    <el-table-column label="编号" width="70" align="center" key="userId" prop="userId" v-if="columns[0].visible" />
                    <el-table-column label="名称" width="150" align="center" key="userName" prop="userName" v-if="columns[1].visible" :show-overflow-tooltip="true" />
                    <el-table-column label="性别" width="100" align="center" key="sex" prop="sex" v-if="columns[2].visible">
                    ...
                    <el-table-column label="昵称" width="150" align="center" key="nickName" prop="nickName" v-if="columns[2].visible" :show-overflow-tooltip="true" />
                    ...
                    <el-table-column label="角色" align="center" prop="roleNameArray">
                        <template #default="scope">
                            <!-- prettier-ignore -->
                            <data-tag v-model:roles-array="scope.row.roleNameArray"/>
                        </template>
                    </el-table-column>
                    <el-table-column label="手机号码" width="120" align="center" key="phonenumber" prop="phonenumber" v-if="columns[4].visible" />
