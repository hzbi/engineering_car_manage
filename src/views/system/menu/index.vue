    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch">
            <el-form-item label="菜单名称" prop="menuName">
                <el-input maxlength="100" v-model="queryParams.menuName" placeholder="请输入菜单名称" style="width: 240px" clearable @keyup.enter="handleQuery()" @clear="handleQuery()" />
            </el-form-item>
        ...
        <el-table v-if="refreshTable" v-loading="loading" :data="menuList" row-key="menuId" :default-expand-all="isExpandAll" :tree-props="{ children: 'children', hasChildren: 'hasChildren' }">
            <!-- prettier-ignore -->
            <el-table-column prop="menuName" label="菜单名称" :show-overflow-tooltip="true" min-width="120" />
            ...
            <!-- prettier-ignore -->
            <el-table-column prop="component" label="组件路径" min-width="120" :show-overflow-tooltip="true" />
            ...
            <el-table-column :label="$t('tableColumn.operation')" align="center" min-width="200" class-name="small-padding fixed-width" fixed="right">
                <template #default="scope">
                    <el-link class="table_link_btn" :underline="false" type="primary" @click="handleUpdate(scope.row)" v-hasPermi="['system:menu:edit']"><span class="table_link_text">修改</span></el-link>
                    <el-link class="table_link_btn" :underline="false" type="primary" @click="handleAdd(scope.row)" v-hasPermi="['system:menu:add']"><span class="table_link_text">新增</span></el-link>
                    <el-link class="table_link_btn" :underline="false" type="danger" @click="handleDelete(scope.row)" v-hasPermi="['system:menu:remove']"><span class="table_link_text">删除</span></el-link>
                </template>
            </el-table-column>
        </el-table>

        <el-table border stripe ref="pageTableRef" v-if="pageTable" v-loading="pageLoading" :data="menuPage" @selection-change="multipleSelection">
        ...
        <el-dialog :title="title" v-model="open" width="40%" append-to-body @closed="cleanSelect()">
            <el-form ref="menuRef" :model="form" :rules="rules" label-width="110px">
                <el-row>
                    ...
                    <el-col :span="24" v-if="form.menuType != 'F'">
                        <el-form-item label="菜单图标" prop="icon">
                            <el-popover placement="bottom-start" :width="560" v-model:visible="showChooseIcon" trigger="click">
                                <template #reference>
                                    <!-- prettier-ignore -->
                                    <el-input maxlength="100" v-model="form.icon" placeholder="点击选择图标" @click="showSelectIcon" readonly >
										<template #prefix>
                                            <!-- prettier-ignore -->
											<svg-icon
												v-if="form.icon"
                    ...
                    <el-col :span="12">
                        <el-form-item label="菜单名称" prop="menuName">
                            <el-input maxlength="100" v-model="form.menuName" placeholder="请输入菜单名称" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                    ...
                    <el-col :span="12" v-if="form.menuType != 'F'">
                        <el-form-item prop="path">
                            ...
                            <el-input maxlength="100" v-model="form.path" placeholder="请输入路由地址" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12" v-if="form.menuType == 'C'">
                        <el-form-item prop="component">
                            ...
                            <el-input maxlength="100" v-model="form.component" placeholder="请输入组件路径" />
                        </el-form-item>
                    </el-col>
