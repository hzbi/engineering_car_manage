        ...
        <el-tabs v-model="activeName">
            ...
            <el-tab-pane label="字段信息" name="cloum">
                <el-table ref="dragTable" :data="cloumns" row-key="columnId" :max-height="tableHeight">
                    <el-table-column :label="$t('tableColumn.index')" type="index" width="50" class-name="allowDrag" />
                    <el-table-column label="字段列名" prop="columnName" width="200" :show-overflow-tooltip="true" />
                    <el-table-column label="字段描述" min-width="10%">
                        <template #default="scope">
                            <el-input maxlength="100" v-model="scope.row.columnComment"></el-input>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="java属性" min-width="10%">
                        <template #default="scope">
                            <el-input maxlength="100" v-model="scope.row.javaField"></el-input>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="字典类型" min-width="12%">
                        <template #default="scope">
                            <el-select v-model="scope.row.dictType" clearable filterable :placeholder="$t('components.select.placeholder')">
