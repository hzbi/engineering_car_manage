    ...
    <div class="app-container">
        <el-form ref="queryFormRef" :model="queryParams" :inline="true" label-width="68px">
            <el-form-item label="登录地址" prop="ipaddr">
                <el-input maxlength="100" v-model="queryParams.ipaddr" placeholder="请输入登录地址" clearable />
            </el-form-item>
            <el-form-item label="用户名称" prop="userName">
                <el-input maxlength="100" v-model="queryParams.userName" placeholder="请输入用户名称" clearable />
            </el-form-item>
            <!-- prettier-ignore -->
        ...
        <el-table
			...
			style="width: 100%;"
		>
			<el-table-column :label="$t('tableColumn.index')" type="index" align="center" width="55">
