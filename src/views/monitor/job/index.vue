    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryFormRef" :inline="true" v-show="showSearch" label-width="68px">
            <el-form-item label="任务名称" prop="jobName">
                <el-input maxlength="100" v-model="queryParams.jobName" placeholder="请输入任务名称" clearable @keyup.enter.native="handleQuery()" />
            </el-form-item>
            <el-form-item label="任务组名" prop="jobGroup">
                <el-select v-model="queryParams.jobGroup" placeholder="请选择任务组名" clearable @change="handleQuery()">
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button type="primary" plain icon="plus" size="small" @click="handleAdd" v-hasPermi="['monitor:job:add']">{{ $t('operationButtons.add.label') }}</el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button type="warning" plain icon="download" size="small" @click="handleExport" v-hasPermi="['monitor:job:export']">{{ $t('operationButtons.export.label') }}</el-button>
            </el-col>
            <el-col :span="1.5">
            ...
            <el-col :span="1.5" v-if="!single">
                <el-button type="success" plain icon="edit" size="small" :disabled="single" @click="handleUpdate" v-hasPermi="['monitor:job:edit']">{{ $t('operationButtons.edit.label') }}</el-button>
            </el-col>
            <el-col :span="1.5" v-if="!multiple">
                <el-button type="danger" plain icon="delete" size="small" :disabled="multiple" @click="handleDelete" v-hasPermi="['monitor:job:remove']">{{ $t('operationButtons.delete.label') }}</el-button>
            </el-col>
            <!-- prettier-ignore -->
            <right-toolbar v-model:showSearch="showSearch" @queryTable="getList" />
        </el-row>

        <el-table v-loading="loading" scripe border height="560px" ref="pageTableRef" :data="jobList" @selection-change="handleSelectionChange">
            ...
            <el-table-column :label="$t('tableColumn.operation')" align="center" class-name="small-padding fixed-width">
                <template #default="scope">
                    <!--<el-button
                            size="small"
                            type="text"
                    ...
                    <!-- <el-button
                        ...
                        >详细</el-button>-->
                    <el-link class="table_link_btn" :underline="false" icon="edit" size="small" type="primary" @click="handleUpdate(scope.row)" v-hasPermi="['monitor:job:edit']">修改</el-link>
                    <!-- prettier-ignore -->
                    <el-dropdown
						size="small"
                    ...
                    <el-link class="table_link_btn" :underline="false" icon="delete" size="small" type="danger" @click="handleDelete(scope.row)" v-hasPermi="['monitor:job:remove']">删除</el-link>
                </template>
            </el-table-column>
        </el-table>
            ...
            <el-form ref="formRef" :model="formData" :rules="rules" label-width="100px">
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="任务名称" prop="jobName">
                            <!-- prettier-ignore -->
                            <el-input maxlength="100" v-model="formData.jobName" placeholder="请输入任务名称" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="任务分组" prop="jobGroup">
                            <!-- prettier-ignore -->
                            <el-select v-model="formData.jobGroup" :placeholder="$t('components.select.placeholder')" style="width: 100%;">
								<el-option
                    ...
                    <el-col :span="24">
                        <el-form-item label="调用方法" prop="invokeTarget">
                            ...
                            <!-- prettier-ignore -->
                            <el-input maxlength="100" v-model="formData.invokeTarget" placeholder="请输入调用目标字符串" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="cron表达式" prop="cronExpression">
                            <!-- prettier-ignore -->
                            <el-input maxlength="100" v-model="formData.cronExpression" placeholder="请输入cron执行表达式" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
        ...
        <!-- 任务日志详细 -->
        <el-dialog title="任务详细" v-model="openView" width="30%" append-to-body @close="cleanSelect()">
                ...
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="执行策略：">
                            <div v-if="formData.misfirePolicy == 0">默认策略</div>
                            <div v-else-if="formData.misfirePolicy == 1">立即执行</div>
                            <div v-else-if="formData.misfirePolicy == 2">执行一次</div>
                            <div v-else-if="formData.misfirePolicy == 3">放弃执行</div>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
