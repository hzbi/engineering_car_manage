    ...
    <div class="app-container home">
        <el-row :gutter="20">
            <el-col :sm="24" :lg="24">
                <blockquote class="text-warning" style="font-size: 16px; line-height: 40px">
                    领取阿里云通用云产品1888优惠券
                    <br />
                    <el-link href="https://www.aliyun.com/minisite/goods?userCode=brki8iof" type="primary" target="_blank" title="阿里云新用户专享特惠">https://www.aliyun.com/minisite/goods?userCode=brki8iof</el-link>
                    <br />
                    领取腾讯云通用云产品2860优惠券
                    <br />

                    <el-link href="https://cloud.tencent.com/redirect.php?redirect=1025&cps_key=198c8df2ed259157187173bc7f4f32fd&from=console" type="primary" target="_blank" title="腾讯云新客专属福利">https://cloud.tencent.com/redirect.php?redirect=1025&cps_key=198c8df2ed259157187173bc7f4f32fd&from=console</el-link>
                    <br />
        ...
        <el-row :gutter="20">
            <el-col :sm="24" :lg="12" style="padding-left: 20px">
                <h2>若依后台管理框架</h2>
                <p>一直想做一款后台管理系统，看了很多优秀的开源项目但是发现没有合适自己的。于是利用空闲休息时间开始自己写一套后台系统。如此有了若依管理系统。，她可以用于所有的Web应用程序，如网站管理后台，网站会员中心，CMS，CRM，OA等等，当然，您也可以对她进行深度定制，以做出更强系统。所有前端后台代码封装过后十分精简易上手，出错概率低。同时支持移动客户端访问。系统会陆续更新一些实用功能。</p>
                <p>
                    <b>当前版本:</b>
                    <span>v{{ version }}</span>
                </p>
                ...
                <p>
                    <el-link :underline="false" href="https://gitee.com/y_project/RuoYi-Vue" type="primary" title="点击访问码云主页" icon="position" target="_blank"><span class="table_link_text">访问码云</span></el-link>
                    <el-link :underline="false" style="margin-left: 30px" href="http://ruoyi.vip" title="点击访问若依主页" type="primary" icon="position" target="_blank"><span class="table_link_text">访问主页</span></el-link>
                </p>
            </el-col>
        ...
        <el-row :gutter="20">
            ...
            <el-col :xs="24" :sm="24" :md="12" :lg="8">
                <el-card class="update-log">
                    ...
                    <span style="height: 30px; line-height: 30px; color: #458b00">你可以请作者喝杯咖啡表示鼓励</span>
                    <div class="body" style="text-align: left; width: 50%">
                        <img src="https://oscimg.oschina.net/oscnet/up-d6695f82666e5018f715c41cb7ee60d3b73.png" alt="donate" width="500" />
                    </div>
                </el-card>
            </el-col>
            <el-col :xs="24" :sm="24" :md="12" :lg="8">
